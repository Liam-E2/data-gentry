...
class EmbeddingSource(ABC):
    ...
    Methods:
        ...
        _get_embedding_impl: (text: str) => List[float]  # Override this in subclasses
    """
...
class BedrockEmbeddingSource(EmbeddingSource):
    ...
    """
    def __init__(self, client: BedrockRuntimeClient, model_id: str = "amazon.titan-embed-text-v2:0", cache_size: int = 10000) -> None:
        super().__init__(cache_size)
        self.client = client
